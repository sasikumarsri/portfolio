...
export class CubeComponent implements OnInit, AfterViewInit {
  ...
  @Input() public texture: string = "/assets/earth.jpg";
  ...
  private cube: THREE.Mesh = new THREE.Mesh(new THREE.SphereGeometry(5, 50, 50), new THREE.ShaderMaterial({vertexShader}));
